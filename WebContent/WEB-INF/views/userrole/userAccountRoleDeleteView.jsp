...
<html>
<head>
<title>Delete a role from an existing user account</title>
...
<body class=" app-auth useraccount delete-confirmation">
	...
	<div id="container">
		...
		<div class="breadcrumbs">
			<a href="/admin/">Home</a> &rsaquo; Online Shopping &rsaquo; <a
		...
		<div id="content" class="colM">
			...
			<p>Are you sure you want to delete the role
				"${role.name}" from the user account "${account.userName}" ?</p>
